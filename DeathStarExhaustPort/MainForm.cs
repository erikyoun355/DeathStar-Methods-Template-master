...
namespace DeathStarExhaustPort
{
    public partial class MainForm : Form
    {
        ...
        public void Xwing(float x, float y, float width, float height)
        {
            ...
            Pen shipePenRed = new Pen(Color.DarkRed);
            ...
            offScreen.DrawLine(shipPen, x, y + height - (height / 5), x + (width / 5), y + height - (height / 4));
            offScreen.DrawLine(shipPen, x + (width / 5), y + height - (height / 4), x + (width / 5), y + height - (height / 4));
            offScreen.DrawLine(shipPen, x + (width / 5), y + height - (height / 4), x + (width / 3), y + height - (height / 2));
            offScreen.DrawLine(shipPen, x + (width / 3), y + height - (height / 2), x + (width / 2 + width/3 ), y + height - (height / 2));
            */
        }
